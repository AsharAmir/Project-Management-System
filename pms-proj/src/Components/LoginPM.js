        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', backgroundColor: '#222', color: '#fff' }}>
            <div style={{ backgroundColor: '#333', padding: '20px', borderRadius: '8px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)', textAlign: 'center' }}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button
                        type="submit"
                        style={{ backgroundColor: '#4CAF50', color: '#fff', padding: '10px 15px', margin: '8px 0', border: 'none', borderRadius: '4px', cursor: 'pointer', width: '100%', transition: 'background-color 0.3s' }}
                    >
                        Login
                    </button>
                </form>
                <div style={{ marginTop: '20px' }}>
                    <Link to="/RegisterPM" style={{ color: '#4CAF50', textDecoration: 'none' }}>Register as a new PM</Link>
                </div>
            </div>
        </div>
    );
